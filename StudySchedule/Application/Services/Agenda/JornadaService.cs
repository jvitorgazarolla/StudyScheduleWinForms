...
namespace StudySchedule.Application.Services.Agenda
{
    public class JornadaService
    {
        ...
        public (bool ok, string msg, int? id)Inserir(int  profissionalId,  DateTime data, TimeSpan horaInicio, TimeSpan horaFim, TimeSpan duracao)
        {
            try
            {
                var id = _repo.Inserir(profissionalId, data, horaInicio, horaFim, duracao);
        ...
        public (bool ok, string msg, int? id)Atualizar(int id, int? profissionalId = null, DateTime? data = null, TimeSpan? horaInicio = null, TimeSpan? horaFim = null, TimeSpan? duracao = null)
        {
            try
            {

                var result = _repo.Atualizar(id, profissionalId, data, horaInicio, horaFim, duracao);
